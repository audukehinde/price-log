<template>
  <div class="hidden md:block  md:w-56 bg-primary-color md:h-[100vh]">
   <img src="@/assets/logo1.png" alt="" class=" w-44 p-4">

    <div class="">
      <!-- <h1 class="text-center text-white font-bold">PRICE CATALOGUE</h1> -->
      <router-link to="/item">
      <!-- <Dropdown
